...
const CalendarDay = ({ day, reservations, onClick }) => {
  ...
  if (!day) {
    return <div className="min-h-20 p-2 border rounded-lg bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600" />;
  }
  ...
  return (
    ...
    >
      <div className="font-semibold text-gray-800 dark:text-white text-sm">{day}</div>
      {reservations.length > 0 && (
        <>
          ...
          {showTooltip && reservations.length > 0 && (
            <div className="absolute z-50 left-0 top-full mt-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-xl p-3 min-w-64 max-w-xs">
              <div className="space-y-2">
                {reservations.slice(0, 3).map((reservation, idx) => {
                  ...
                  return (
                    <div key={idx} className="text-xs border-b dark:border-gray-700 last:border-0 pb-2 last:pb-0">
                      ...
                      <div className="text-gray-600 dark:text-gray-400 flex items-center gap-1 mt-1">
